...
namespace JMS.Domains
{
    class GatewayRefereeClient
    {
            ...
            ILogger<GatewayRefereeClient> logger)
        {
            ...
            {
                _registerServiceManager.ServiceConnect += OnServiceConnect;
                _registerServiceManager.ServiceDisconnect += OnServiceDisconnect;
            ...
            SystemEventCenter.MicroServiceUploadLockedKeyCompleted += OnMicroServiceUploadLockedKeyCompleted;
        }
        ...
        private void OnServiceDisconnect(object sender, RegisterServiceInfo e)
        {
            RemoveMicroService(e);
        }

        private void OnServiceConnect(object sender, RegisterServiceInfo e)
        {
            AddMicroService(e);
        }

        private void OnMicroServiceUploadLockedKeyCompleted(object sender, RegisterServiceInfo e)
        {
